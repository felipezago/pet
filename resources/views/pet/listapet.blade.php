        ...
        <header id="topnav">
            <nav class="navbar-custom">
                ...
                <ul class="list-unstyled menu-left mb-0">
                    ...
                    <li class="float-left"><a href="/pets" class="logo side-menu-sm-logo"><span
                    ...
                    <ul class="metismenu" id="side-menu" style="height: 25px;">
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-view-dashboard"></i> <span>Meus Pets!</span><span
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li><a href="">Vizualizar Pets</a></li>
                            </ul>
                        </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" >
                        <div class="col-12" style="height: 200px;">
                            <div class="card-box" >
                                <h4 class="header-title mb-3">Meus Pets!</h4>
                                <div class="table-responsive"   id = "pets">
                                    <table class="table table-centered table-hover mb-0" id="datatable">
                                        <thead >
                                            <tr>
                                                <th class="border-top-0">Nome</th>
                                                <th class="border-top-0">Especie</th>
                                                <th class="border-top-0">Raça</th>
                                                <th class="border-top-0">Altura</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td style=" width: 22%">
                                                    ...
                                                    <button id="btn-excluir" type="button" class="btn btn-danger btn-rounded w-sm" onclick="deletar({{ $pet->id }})">
                                                        Excluir
                                                    </button>
                                                </td>
                                            </tr>
